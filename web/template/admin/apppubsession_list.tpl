...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d %H:%M:%S");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					...
					<td><a href="admin.php?controller=admin_apppub&addr={{$allsession[t].addr}}&backupdb_id={{$backupdb_id}}">{{$allsession[t].addr}}</a></td>
						...
						<a id="p_{{$allsession[t].id}}" onClick="return go('admin.php?controller=admin_rdp&mstsc=1&sid={{$allsession[t]['sid']}}&method=apppub','p_{{$allsession[t].id}}')" href="#"   target="hide">RDP</a>&nbsp;|&nbsp;&nbsp; <img src="./template/admin/images/input.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_apppub&action=inputview&sid={{$allsession[t]['sid']}}" target="_blank">录入</a>
						| <img src="{{$template_root}}/images/ie_ico.png" width="16" height="16" align="absmiddle"> <a href="admin.php?controller=admin_apppub&action=view&sid={{$allsession[t]['sid']}}">URL查看</a>
