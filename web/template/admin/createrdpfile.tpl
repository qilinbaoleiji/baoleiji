...
<ul>
  ...
  <tr>
	<td class=""><table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%" class="BBtable">
			...
			<tr>
			<td>mRemote</td>
			<td>堡垒机IP:<input name="baoleijiip" id="" value="{{$eth0}}" type="text" width=50 />&nbsp;&nbsp;&nbsp;&nbsp;端口:<input name="port" id="" value="3389" type="text" width=50 />&nbsp;&nbsp;&nbsp;&nbsp;域名连接:<input type="checkbox" name="m_bydomain" id="m_bydomain" {{if $m_bydomain}}checked{{/if}} value="1"  />&nbsp;&nbsp;&nbsp;&nbsp;<input name="submit" type="submit" value="{{$language.Commit}}" /></td>
			</tr>
			</form>
			...
			<tr>
			<td>RDCMAN</td>
			<td>堡垒机IP:<input name="baoleijiip" id="" value="{{$eth0}}" type="text" width=50 />&nbsp;&nbsp;&nbsp;&nbsp;端口:<input name="port" id="" value="3389" type="text" width=50 />&nbsp;&nbsp;&nbsp;&nbsp;域名连接:<input type="checkbox" name="r_bydomain" id="r_bydomain" {{if $r_bydomain}}checked{{/if}} value="1"  />&nbsp;&nbsp;&nbsp;&nbsp;<input name="submit" type="submit" value="{{$language.Commit}}" /></td>
			</tr>
			</form>
			...
			<tr>
			<td>Xshell</td>
			<td>堡垒机IP:<input name="baoleijiip" id="" value="{{$eth0}}" type="text" width=50 />&nbsp;&nbsp;&nbsp;&nbsp;端口:<input name="port" id="" value="22" type="text" width=50 />&nbsp;&nbsp;&nbsp;&nbsp;默认:<select name="template" ><option value="">无</option><option value="3">XShell3</option><option value="4">XShell4</option></select>模版:<input name="xshelltemplate" id="" type="file" width=50 />&nbsp;&nbsp;&nbsp;&nbsp;域名连接:<input type="checkbox" name="x_bydomain" id="x_bydomain" {{if $x_bydomain}}checked{{/if}} value="1"  />&nbsp;&nbsp;&nbsp;&nbsp;<input name="submit" type="submit" value="{{$language.Commit}}" /></td>
			</tr>
			</form>
		</table>
	</td>
