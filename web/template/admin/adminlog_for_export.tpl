  ...
  <tr>
	<td class="main_content">
		...
		<tr>
                    ...
                    <th class="list_bg" >运维组</TD>
                    <th class="list_bg" >操作</TD>
					<th class="list_bg" >资源</TD>
					<th class="list_bg" >资源用户</TD>
					...
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						...
						<td>{{if $alldev[t].luser}}{{$alldev[t].luser}}{{/if}}</td>
						<td>{{$alldev[t].realname}}</td>
						<td>{{$alldev[t].groupname}}</td>
						<td>{{$alldev[t].action}}</td>
						<td>{{$alldev[t].resource}}</td>
						<td>{{$alldev[t].resource_user}}</td>
