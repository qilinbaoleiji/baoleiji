...
<tr><th colspan="6" class="list_bg"></th></tr>
	...
	<tr><td align="right">Radius主:</td>		
	<td>
		<input type="text" class="wbk" name="address" value="{{$sshconfig.address}}" />	
		</td>		
	<td align="right">Radius主端口:</td>		
	<td>
		<input type="text" class="wbk" name="port" value="{{$sshconfig.port}}" />	</td>		
	<td align="right">
		Radius主key:</td>		
	<td>
...
<td align="right">Radius从端口:</td>		
	<td>
		<input type="text" class="wbk" name="slaveport" value="{{$sshconfig.slaveport}}" />	</td>		
	<td align="right">
		Radius从key:</td>		
	<td>
		<input type="text" class="wbk" name="slavesecret" value="{{$sshconfig.slavesecret}}" />	
		</td>
...
<td align="right">LDAP服务器端口:</td>		
	<td>
		<input type="text" class="wbk" name="ldapport[]" value="{{$ldaps[l].port}}" />	</td>		
	<td align="right">
		LDAP服务器DC:</td>		
	<td>
		<input type="text" class="wbk" name="ldapdomain[]" value="{{$ldaps[l].domain}}" />	&nbsp;&nbsp;<input type="button" onclick="document.getElementById('ldapip_{{$smarty.section.l.index}}').value='';document.f1.submit();"  value="删除" class="an_02">&nbsp;&nbsp;<input type="button" onclick="window.open ('admin.php?controller=admin_config&action=ldapusers&id={{$smarty.section.l.index}}', 'newwindow', 'height=460, width=600, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=yes,location=no, status=no');"  value="添加LDAP账号" class="an_06">
		</td>
...
<td align="right"> AD 服务器端口:</td>		
	<td>
		<input type="text" class="wbk" name="adport[]" value="{{$ads[a].port}}" />	</td>		
	<td align="right">
		 AD域 :</td>		
	<td>
		<input type="text" class="wbk" name="addomain[]" value="{{$ads[a].domain}}" />	&nbsp;&nbsp;<input type="button" onclick="document.getElementById('adip_{{$smarty.section.a.index}}').value='';document.f1.submit();"  value="删除" class="an_02">&nbsp;&nbsp;<input type="button" onclick="window.open ('admin.php?controller=admin_config&action=adusers&id={{$smarty.section.a.index}}', 'newwindow', 'height=460, width=600, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=yes,location=no, status=no');"  value="添加AD账号" class="an_06">&nbsp;&nbsp;<input type="button" onclick="window.open ('admin.php?controller=admin_config&action=adimportconfig&adserverindex={{$smarty.section.a.index}}', 'newwindow', 'height=460, width=600, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=yes,location=no, status=no');"  value="导入策略" class="an_06">
		</td>		
	</tr>
{{/section}}
