		...
		<td>	
			<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
					<tr>
						...
						<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_reports&action=admin_log&orderby1=luser&orderby2={{$orderby2}}" >运维用户</a></th>	
						<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_reports&action=admin_log&orderby1=luser&orderby2={{$orderby2}}" >别名</a></th>	
						<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_reports&action=admin_log&orderby1=action&orderby2={{$orderby2}}" >{{$language.Operate}}</a></th>
						<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_reports&action=admin_log&orderby1=resource&orderby2={{$orderby2}}" >资源</a></th>
						<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_reports&action=admin_log&orderby1=resource_user&orderby2={{$orderby2}}" >资源{{$language.User}}</a></th>
						<th class="list_bg"  ><a href="admin.php?controller=admin_reports&action=admin_log&orderby1=optime&orderby2={{$orderby2}}" >{{$language.OperateTime}}</a></th>
					</tr>
					...
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						...
						<td>{{if $allmember[t].luser}}{{$allmember[t].luser}}{{/if}}</td>
						<td>{{$allmember[t].realname}}</td>
