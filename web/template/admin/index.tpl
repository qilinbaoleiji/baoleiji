...
{{if $user.webportal}}
<!--
var maxtime = {{$sessionlifetime}}; //小时，分钟，秒，可以读取数据库时间函数
function CountDown(){
if(maxtime>=0){
...
{{/if}}
<li><a href="admin.php?controller=admin_index&action=changerole&level={{$user.level}}">{{if $user.level eq 1}}{{elseif $user.level eq 2}}运维{{elseif $user.level eq 3}}部门{{elseif $user.level eq 4}}配置{{elseif $user.level eq 10}}密码{{/if}}管理员</a></li>
</ul> 
</li> 
