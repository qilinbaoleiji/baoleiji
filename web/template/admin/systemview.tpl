    ...
    <td><table border="0" cellspacing="0" cellpadding="0" width="99%">
            ...
            <tbody>
              <tr>
                ...
                align="middle"><strong><a style="CURSOR: hand" class="ly" 
                  ...
                  onclick="changeInstanceId('#')">Windows 
                  OS...</a> </strong></td>
      ...
      <tr>
        ...
        <table id="detailInfo" border="0" cellspacing="0" cellpadding="0" 
            ...
            <tbody>
              <tr>
                <td width="235" valign="top"><iframe  src="admin.php?controller=admin_detail&action=hostleftmenu&ip={{$ip}}" name="iframe2" width="245" marginwidth="0"  height="586" marginheight="0"  scrolling="No"  frameborder="0" ></iframe></td>
                <td valign="top"><iframe src="admin.php?controller=admin_detail&action=hostview&ip={{$ip}}" name="rightmain" width="100%"  marginwidth="0" height="586"  marginheight="0" scrolling="No"  frameborder="0" ></iframe></td>
              </tr>
            </tbody>
          </table>
