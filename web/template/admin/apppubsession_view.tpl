	...
	<td colspan="2" class="">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
			...
			<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
				...
				<td><a id="p_{{$allcommand[t].id}}" onClick="return go('admin.php?controller=admin_rdp&mstsc=1&sid={{$allcommand[t]['sid']}}&replaystime={{$allcommand[t].ustart}}&method=apppub','p_{{$allcommand[t].id}}')" href="#"   target="hide">RDP</a></td>
			</tr>
			{{/section}}
			<tr>
