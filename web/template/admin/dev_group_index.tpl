  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="BBtable">
			...
			<tr  {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
				<TD  onClick="toggle_group('ldap_{{$smarty.section.t.index}}', $('a_ldap_{{$smarty.section.t.index}}'))" class=td25 width="30" align="center">{{if $alldev[t].childrenct gt 0}}<span class="td25"><A id=a_ldap_{{$smarty.section.t.index}} href="javascript:;">[+]</A></span>{{/if}}</TD>
