...
<td width="84%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable"><tr>
					<td colspan="8">日期:{{$f_rangeStart}} 到 {{$f_rangeEnd}}</td>
					</tr>
					<tr>
						...
						<th class="list_bg"   width="5%">telnet</th>
						...
						<th class="list_bg"   width="5%">前台</th>
						<th class="list_bg"   width="5%">X11</th>
						<th class="list_bg"   width="10%">{{$language.total}}</th>
					</tr>
