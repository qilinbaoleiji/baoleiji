...
<table><tr >
						...
						<td width="100">
							...
							<td width="100"><input type="radio" name="controller" value="admin_apppub" onClick="location.href='admin.php?controller=admin_apppub&action=urlsearch'">应用URL</td><td></td><td></td><td></td><td></td><td></td>
						</tr></table>
						</td>
					</tr>
					<tr>
