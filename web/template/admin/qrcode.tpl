...
cellpadding="0">
                    <TBODY>
                    <TR>
                      <TD width="25%" height="45" align="center" colspan=2>用户名：{{$userinfo.username}}</TD></TR>
                      ...
                      <TR>
                        <TD height=45 align=center colspan=2>输入动态密码：<input type=password name="qrcode" id="qrcode" style="WIDTH: 200px; height:30px; line-height:30px;"  value="" ></TD>
					  </TR>
					  {{else}}
