...
<ul>
	...
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_eth&action=route_list">VPN -路由</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
  ...
  <tr>
	...
	{{assign var="trnumber" value=0}}
		...
		<td width="67%"><input type="text"  name="netmask" value="{{$p.netmask}}" /></td>
	  </tr>
