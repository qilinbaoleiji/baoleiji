...
<form name="f1" method=post OnSubmit='return check()' action="admin.php?controller=admin_backup&action=cronjob">
	...
	<tr>
			<td></td><td align="left"><input type="submit"  value="保存修改" class="an_02">{{if $smarty.session.ADMIN_LEVEL ne 10}}&nbsp;&nbsp;&nbsp;<input type="button" onclick="window.location='admin.php?controller=admin_backup&action=cronjob_audit'" value="审计文件备份" class="an_06">&nbsp;&nbsp;&nbsp;<input type="button" onclick="window.location='admin.php?controller=admin_backup&action=cronjob_mastslav'" value="立即主从服务器备份" class="an_06">&nbsp;&nbsp;&nbsp;<input type="button" onclick="window.location='admin.php?controller=admin_backup&action=cronjob_autodelete'"  value="立即自动删除" class="an_06">{{/if}}</td>
		</tr>
