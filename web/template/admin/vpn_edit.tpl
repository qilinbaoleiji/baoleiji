...
<ul>
	...
	<li class="me_a"><img src="{{$template_root}}/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_eth&action=route_list">VPN -策略</a><img src="{{$template_root}}/images/an3.jpg" align="absmiddle"/></li>
  ...
  <tr>
	...
	{{assign var="trnumber" value=0}}
		...
		<td width="67%"><input type="text" name="s_addr" size="40" value="{{$p.s_addr}}" /></td>
	</tr>
	
		{{assign var="trnumber" value=$trnumber+1}}
					<tr {{if $trnumber % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
		<td width="33%" align=right>目标地址</td>
		<td width="67%"><input type="text"  name="d_addr" size="40" value="{{$p.d_addr}}" /></td>
	  </tr>
	 {{assign var="trnumber" value=$trnumber+1}}
					<tr {{if $trnumber % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
		<td width="33%" align=right>映射地址</td>
		<td width="67%"><input type="text"  name="p_addr" size="40" value="{{$p.p_addr}}" /></td>
	  </tr>
