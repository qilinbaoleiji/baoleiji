...
<script src="{{$template_root}}/cssjs/cn.js"></script><script src="./template/admin/cssjs/global.functions.js"></script>
<script>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		...
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%" >
			...
			{{$language.WebUser}}{{$language.User}}：<input type="text" class="wbk" name="luser">&nbsp;&nbsp;{{include file="select_sgroup.tpl" }}
		...
		<td>	
			<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
					<tr>
						...
						<th class="list_bg"  width="20%"><a href="admin.php?controller=admin_log&action=adminlog&orderby1=luser&orderby2={{$orderby2}}" >{{$language.WebUser}}{{$language.User}}/资源组</a></th>
						...
						<th class="list_bg"  width="20%"><a href="admin.php?controller=admin_log&action=admin_log&orderby1=resource&orderby2={{$orderby2}}" >资源</a></th>
					...
					<tr {{if $smarty.section.t.index % 2 == 0}}bgcolor="f7f7f7"{{/if}}>
						...
						<td>{{if $allmember[t].luser}}{{$allmember[t].luser}}{{else}}{{$allmember[t].lgroup}}{{/if}}</td>
