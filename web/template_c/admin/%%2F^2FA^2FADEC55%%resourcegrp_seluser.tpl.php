<?php /* Smarty version 2.6.18, created on 2014-04-24 23:48:14
         compiled from resourcegrp_seluser.tpl */ ?>
              ...
              <TABLE width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" valign="top"  class="BBtable">
                <TBODY>
                  ...
                  <TR id="autosutr" bgcolor="#f7f7f7">
                    ...
                    <TD><INPUT id="autosu" <?php if ($this->_tpl_vars['luser']['autosu'] == 1): ?> checked <?php endif; ?> type=checkbox name=autosu value="on">                      </TD>
                  </TR>
                  <TR id="autosutr">
                    <TD width="50%" align="right"><?php echo $this->_tpl_vars['language']['syslogAlertwhenloginin']; ?>
</TD>
                    <TD><INPUT id="syslogalert" <?php if ($this->_tpl_vars['luser']['syslogalert'] == 1): ?> checked <?php endif; ?> type=checkbox name=syslogalert value="on">                  </TD>
                  </TR>
                  <TR id="autosutr" bgcolor="#f7f7f7">
                    <TD width="50%" align="right"><?php echo $this->_tpl_vars['language']['mailalertwhenloginin']; ?>
</TD>
                    <TD><INPUT id="mailalert" <?php if ($this->_tpl_vars['luser']['mailalert'] == 1): ?> checked <?php endif; ?> type=checkbox name=mailalert value="on">              </TD>
                  </TR>
                  <TR id="autosutr">
                  ...
                  <TR id="autosutr" bgcolor="#f7f7f7">
                    ...
                    <TD><INPUT id="loginlock" <?php if ($this->_tpl_vars['luser']['rdpdiskauth_up'] == 1): ?> checked <?php endif; ?> type=checkbox name=rdpdiskauth_up value="on">                </TD>
                  </TR>
                  <TR id="autosutr">
                    <TD width="50%" align="right">剪切板上行 </TD>
                    <TD><INPUT id="loginlock" <?php if ($this->_tpl_vars['luser']['rdpclipauth_up'] == 1): ?> checked <?php endif; ?> type=checkbox name=rdpclipauth_up value="on">           </TD>
                  </TR>
				  <TR id="autosutr" bgcolor="#f7f7f7">
                    <TD width="50%" align="right">剪切板下行 </TD>
                    <TD><INPUT id="loginlock" <?php if ($this->_tpl_vars['luser']['rdpclipauth_down'] == 1): ?> checked <?php endif; ?> type=checkbox name=rdpclipauth_down value="on">           </TD>
                  </TR>
                  <TR>
...
" <?php if ($this->_tpl_vars['allforbiddengroup'][$this->_sections['f']['index']]['gname'] == $this->_tpl_vars['luser']['forbidden_commands_groups']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['allforbiddengroup'][$this->_sections['f']['index']]['gname']; ?>
...
" <?php if ($this->_tpl_vars['webusers'][$this->_sections['w']['index']]['uid'] == $this->_tpl_vars['luser']['twoauth']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['webusers'][$this->_sections['w']['index']]['username']; ?>
</option>
			<?php endfor; endif; ?>
                  </SELECT>       </TD>
                  </TR>
