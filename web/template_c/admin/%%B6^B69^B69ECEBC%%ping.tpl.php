<?php /* Smarty version 2.6.18, created on 2014-04-20 10:50:54
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_eth&action=ping">PING</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
$this->_sections['t']['loop'] = is_array($_loop=$this->_tpl_vars['pinginfo']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
			<tr bgcolor='<?php if ($this->_sections['t']['index'] % 2 == 0): ?>f7f7f7<?php endif; ?>'>
	           <td  align="left"><?php echo $this->_tpl_vars['pinginfo'][$this->_sections['t']['index']]; ?>
</td>
                </tr>
            <?php endfor; endif; ?>
		</TBODY>
