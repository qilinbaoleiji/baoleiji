<?php /* Smarty version 2.6.18, created on 2014-04-30 23:27:27
         compiled from rdplogin_activex.tpl */ ?>
<head>
...
sub BtnConnect
   ...
   <?php if ($this->_tpl_vars['console'] == 'TRUE'): ?>
	MsRdpClient.AdvancedSettings2.ConnectToServerConsole =<?php echo $this->_tpl_vars['console']; ?>
   ...
   'Device redirection options
    MsRdpClient.AdvancedSettings2.RedirectDrives     = <?php if ($this->_tpl_vars['rdpdiskauth_up']): ?>TRUE<?php else: ?>FALSE<?php endif; ?>
   ...
   <?php if ($this->_tpl_vars['login_method'] != 'RDP'): ?>
	MsRdpClient.SecuredSettings.StartProgram = "<?php echo $this->_tpl_vars['domain']; ?>
"
	MsRdpClient.SecuredSettings.WorkDir = "<?php echo $this->_tpl_vars['workdir']; ?>
"
	<?php endif; ?>
...
"></label><br>
          ...
          <input type="text" class="wbk" name="Domain" id=editDomain size="25" value="<?php echo $this->_tpl_vars['password']; ?>
<?php echo $this->_tpl_vars['dynamic_pwd']; ?>
"></label></p></span>	
