<?php /* Smarty version 2.6.18, created on 2014-05-07 15:59:39
         compiled from cmdlistreport_for_export.tpl */ ?>
  ...
  <tr>
	<td class="main_content">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable"><tr>
					<td colspan="7">日期:<?php echo $this->_tpl_vars['f_rangeStart']; ?>
...
?>
					<tr <?php if ($this->_sections['t']['index'] % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
						...
						<td width="10%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['addr']; ?>
</td>
						...
						<td width="10%"><?php if (! $this->_tpl_vars['reports'][$this->_sections['t']['index']]['level']): ?>正常<?php elseif ($this->_tpl_vars['reports'][$this->_sections['t']['index']]['level'] == 1): ?>危险<?php elseif ($this->_tpl_vars['reports'][$this->_sections['t']['index']]['level'] == 2): ?>严重<?php elseif ($this->_tpl_vars['reports'][$this->_sections['t']['index']]['level'] == 3): ?>警告<?php elseif ($this->_tpl_vars['reports'][$this->_sections['t']['index']]['level'] == 4): ?>复核<?php endif; ?></td>
					</tr>
					<?php endfor; endif; ?>
