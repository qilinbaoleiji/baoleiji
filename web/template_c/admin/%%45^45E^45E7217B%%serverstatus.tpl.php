<?php /* Smarty version 2.6.18, created on 2014-04-21 14:53:43
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_eth&action=serverstatus">服务状态</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
/images/an33.jpg" align="absmiddle"/></li>
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
			<tr>
				<th class="list_bg"  width="15%"><?php echo $this->_tpl_vars['language']['ServiceName']; ?>
</th>
...
/images/069.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="admin.php?controller=admin_eth&action=serverstatus&sname=<?php echo $this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['sname']; ?>
...
&ac=start"><?php echo $this->_tpl_vars['language']['Start']; ?>
				...
				<?php if ($this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['status'] == 1): ?><img src='<?php echo $this->_tpl_vars['template_root']; ?>
/images/070.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="admin.php?controller=admin_eth&action=serverstatus&sname=<?php echo $this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['sname']; ?>
