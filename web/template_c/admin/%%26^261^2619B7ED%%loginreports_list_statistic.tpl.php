<?php /* Smarty version 2.6.18, created on 2014-07-03 19:12:24
         compiled from loginreports_list_statistic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'loginreports_list_statistic.tpl', 58, false),)), $this); ?>
...
function searchit(){
	document.report.action = "<?php echo $this->_tpl_vars['curr_url']; ?>
";
...
/images/an1.jpg" align="absmiddle"/><a href="#">登录统计</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
<?php endif; ?><span class="back_img"><A href="admin.php?controller=admin_reports&action=<?php if ($_GET['dateinterval'] == 'diy'): ?>report_search_diy<?php else: ?>report_search<?php endif; ?>&back=1"><IMG src="./template/admin/images/back1.png" width="80" height="25" border="0"></A></span>
</ul>
</div></td></tr>
