<?php /* Smarty version 2.6.18, created on 2014-06-20 12:56:05
         compiled from sftpreport.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'sftpreport.tpl', 66, false),)), $this); ?>
...
function searchit(){
	document.search.action = "admin.php?controller=admin_reports&action=sftpreport";
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=sftpreport&number=3">SFTP<?php echo $this->_tpl_vars['language']['Command']; ?>
...
?>
					<tr <?php if ($this->_sections['t']['index'] % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
						<td width="10%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['radius_user']; ?>
</td>
						...
						<td width="10%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['sftp_user']; ?>
</td>
						<td width="10%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['putct']; ?>
</td>
						<td width="10%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['getct']; ?>
</td>
