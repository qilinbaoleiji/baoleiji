<?php /* Smarty version 2.6.18, created on 2014-06-28 03:11:33
         compiled from sourceip.tpl */ ?>
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_pro&action=sourceip">来源IP组</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="BBtable">
                <TBODY>
                    ...
                    <th class="list_bg" ><a href="admin.php?controller=admin_pro&action=sourceip&orderby1=groupname&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >组名</a></TD>
...
?>
 ...
 <td> <?php echo $this->_tpl_vars['s'][$this->_sections['t']['index']]['groupname']; ?>
</td>
				<td style="TEXT-ALIGN: left;"><img src='<?php echo $this->_tpl_vars['template_root']; ?>
/images/edit_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="admin.php?controller=admin_pro&action=sourceip_list&groupname=<?php echo $this->_tpl_vars['s'][$this->_sections['t']['index']]['groupname']; ?>
" >ip</a>
				| <img src='<?php echo $this->_tpl_vars['template_root']; ?>
/images/delete_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="#" onClick="if(!confirm('您确定要删除？')) {return false;} else { location.href='admin.php?controller=admin_pro&action=sourceip_delete&groupname=<?php echo $this->_tpl_vars['s'][$this->_sections['t']['index']]['groupname']; ?>
';}">删除</a>
				</td> 
			</tr>
			<?php endfor; endif; ?>
	          <tr>
	           <td  colspan="1" align="left">
		           <form action="admin.php?controller=admin_pro&action=sourceip_save&sid=<?php echo $this->_tpl_vars['sip']['sid']; ?>
" method="post">
					<input type="text" class="wbk" name="groupname" />
					<input type="submit" name="submit" value=" 增加 " class="an_02" />
					</form>
		   		</td>
