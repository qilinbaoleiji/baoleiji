<?php /* Smarty version 2.6.18, created on 2014-04-20 10:50:56
         compiled from trace.tpl */ ?>
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_eth&action=tracepath">TRACE</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
	...
	<td class="" colspan = "7"><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="main_content">
                ...
                <TBODY>
				 <TR>
					...
					IP&nbsp;<input type="text" class="wbk" value="<?php echo $this->_tpl_vars['ip']; ?>
" name="ip">
...
$this->_sections['t']['loop'] = is_array($_loop=$this->_tpl_vars['traceinfo']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
			<tr bgcolor='<?php if ($this->_sections['t']['index'] % 2 == 0): ?>f7f7f7<?php endif; ?>'>
	           <td  align="left"><?php echo $this->_tpl_vars['traceinfo'][$this->_sections['t']['index']]; ?>
</td>
                </tr>
            <?php endfor; endif; ?>
		</TBODY>
