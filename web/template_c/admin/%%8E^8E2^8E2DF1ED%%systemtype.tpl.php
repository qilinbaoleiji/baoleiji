<?php /* Smarty version 2.6.18, created on 2014-06-28 03:13:01
         compiled from systemtype.tpl */ ?>
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="BBtable">
                <TBODY>
                  ...
                  <TR>
                    <th class="list_bg" width="40%"><a href="admin.php?controller=admin_pro&action=systemtype&orderby1=device_type&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >系统名称</a></TD>
					 <th class="list_bg" width="40%"><a href="admin.php?controller=admin_pro&action=systemtype&orderby1=sucommand&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" > 超级用户切换命令</a></TD>
...
?>
			<tr <?php if ($this->_sections['t']['index'] % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
				<td ><?php echo $this->_tpl_vars['weektime'][$this->_sections['t']['index']]['device_type']; ?>
</td>
				<td ><?php echo $this->_tpl_vars['weektime'][$this->_sections['t']['index']]['sucommand']; ?>
</td>
				<td >
				<img src='<?php echo $this->_tpl_vars['template_root']; ?>
/images/edit_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="admin.php?controller=admin_pro&action=systemtype_edit&id=<?php echo $this->_tpl_vars['weektime'][$this->_sections['t']['index']]['id']; ?>
" >修改</a>
				| <img src='<?php echo $this->_tpl_vars['template_root']; ?>
/images/delete_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href="#" onClick="if(!confirm('您确定要删除？')) {return false;} else { location.href='admin.php?controller=admin_pro&action=delete_systemtype&id=<?php echo $this->_tpl_vars['weektime'][$this->_sections['t']['index']]['id']; ?>
';}">删除</a>
				</td> 
			</tr>
			<?php endfor; endif; ?>
