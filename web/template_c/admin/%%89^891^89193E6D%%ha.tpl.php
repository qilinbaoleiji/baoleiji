<?php /* Smarty version 2.6.18, created on 2014-04-26 23:10:21
         compiled from ha.tpl */ ?>
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_config&action=ha">高可用性</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
/images/<?php if ($this->_tpl_vars['ha']['start']): ?>Green.gif<?php else: ?>hong.gif<?php endif; ?>" >
		<?php if ($this->_tpl_vars['ha']['start']): ?>启动<?php elseif ($this->_tpl_vars['ha']['doublestatus'] == 'B'): ?>未启动<?php endif; ?></td>
	...
	<td align="right">浮动 IP ：</td>
		<td align=left>
		<input type="text" class="wbk" name="virtual_ipaddress" value="<?php echo $this->_tpl_vars['ha']['virtual_ipaddress']; ?>
" />
		</td>
	...
	<td align="right">状态 ：</td>
		<td align=left>
		<select name="state">
		<option value="MASTER" <?php if ($this->_tpl_vars['ha']['state'] == 'MASTER'): ?>selected<?php endif; ?>>MASTER</option>
		<option value="BACKUP" <?php if ($this->_tpl_vars['ha']['state'] == 'BACKUP'): ?>selected<?php endif; ?>>BACKUP</option>
		</select>
		</td>
	...
	<td align="right">priority ：</td>
		<td align=left>
		<input type="text" class="wbk" name="priority" value="<?php echo $this->_tpl_vars['ha']['priority']; ?>
" readOnly />
		</td>
		
	</tr>
	<tr <?php if ($this->_tpl_vars['trnumber']++ % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
	<td align="right">从IP ：</td>
		<td align=left>
		<input type="text" class="wbk" name="slave_ip" value="<?php echo $this->_tpl_vars['ha']['slave_ip']; ?>
" />
		</td>
		
	</tr>
	<tr <?php if ($this->_tpl_vars['trnumber']++ % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
		<td></td>	<td  align="left"><input type="submit" class=""  value="<?php echo $this->_tpl_vars['language']['Save']; ?>
"></td>
		</tr>

	</table>
	<input type="hidden" name="ac" value="<?php if ($this->_tpl_vars['ha']): ?>edit<?php else: ?>new<?php endif; ?>" />
</form>
