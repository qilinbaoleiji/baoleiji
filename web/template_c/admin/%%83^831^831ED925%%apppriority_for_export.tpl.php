<?php /* Smarty version 2.6.18, created on 2014-06-10 21:49:09
         compiled from apppriority_for_export.tpl */ ?>
  ...
  <tr>
	<td class="main_content">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
					...
					<?php if ($this->_tpl_vars['type'] == 'luser'): ?><th class="list_bg" >运维用户</TD><th class="list_bg" >别名</TD>
					<?php elseif ($this->_tpl_vars['type'] == 'lgroup'): ?><th class="list_bg" ><?php echo $this->_tpl_vars['language']['UserGroup']; ?>
</TD><?php endif; ?>
...
?>
					<tr <?php if ($this->_sections['t']['index'] % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
						...
						<?php if ($this->_tpl_vars['type'] == 'luser'): ?><td><?php echo $this->_tpl_vars['alldev'][$this->_sections['t']['index']]['webuser']; ?>
</td><td><?php echo $this->_tpl_vars['alldev'][$this->_sections['t']['index']]['webrealname']; ?>
</td>
