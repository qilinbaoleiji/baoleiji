<?php /* Smarty version 2.6.18, created on 2014-06-20 13:04:02
         compiled from ftpreport.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'ftpreport.tpl', 66, false),)), $this); ?>
...
function searchit(){
	document.search.action = "admin.php?controller=admin_reports&action=ftpreport";
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=ftpreport&number=6">FTP<?php echo $this->_tpl_vars['language']['Command']; ?>
<?php echo $this->_tpl_vars['language']['report']; ?>
</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
?>
					<tr <?php if ($this->_sections['t']['index'] % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
						...
						<td width="10%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['ftp_user']; ?>
</td>
