<?php /* Smarty version 2.6.18, created on 2014-07-03 23:21:52
         compiled from appprogram_list.tpl */ ?>
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_config&action=appprogram_list">应用程序</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
	...
	<td class="">
		<table bordercolor="white" cellspacing="1" cellpadding="5" border="0" width="100%"  class="BBtable">
			<tr>
				...
				<th class="list_bg"  width="12%"><a href="admin.php?controller=admin_config&action=appprogram_list&ip=<?php echo $this->_tpl_vars['appserverip']; ?>
&orderby1=name&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >应用名称</a></th>
				<th class="list_bg"  width="40%"><a href="admin.php?controller=admin_config&action=appprogram_list&ip=<?php echo $this->_tpl_vars['appserverip']; ?>
&orderby1=name&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >程序路径</a></th>
				
				<th class="list_bg"  width="20%"><a href="admin.php?controller=admin_config&action=appprogram_list&ip=<?php echo $this->_tpl_vars['appserverip']; ?>
&orderby1=name&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >描述</a></th>
...
$this->_sections['t']['loop'] = is_array($_loop=$this->_tpl_vars['appprogram']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
			<tr <?php if ($this->_sections['t']['index'] % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
				<td><input type="checkbox" name="chk_member[]" value="<?php echo $this->_tpl_vars['appprogram'][$this->_sections['t']['index']]['id']; ?>
"></td>
				<td><?php echo $this->_tpl_vars['appprogram'][$this->_sections['t']['index']]['name']; ?>
</td>
				<td><?php echo $this->_tpl_vars['appprogram'][$this->_sections['t']['index']]['path']; ?>
</ td>
				<td><?php echo $this->_tpl_vars['appprogram'][$this->_sections['t']['index']]['description']; ?>
</ td>
				<td>
				
			<img src='./template/admin/images/left_dot1.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href='admin.php?controller=admin_config&action=appprogram_edit&id=<?php echo $this->_tpl_vars['appprogram'][$this->_sections['t']['index']]['id']; ?>
&appserverip=<?php echo $this->_tpl_vars['appprogram'][$this->_sections['t']['index']]['appserverip']; ?>
...
吗?')) return true;else return false;" href="admin.php?controller=admin_config&action=appprogram_delete&id=<?php echo $this->_tpl_vars['appprogram'][$this->_sections['t']['index']]['id']; ?>
...
&nbsp;&nbsp;<input type="submit"  value="删除选中" onclick="if(confirm('确定要删除?')) document.member_list.action='admin.php?controller=admin_config&action=appprogram_delete&appserverip=<?php echo $this->_tpl_vars['appserverip']; ?>
';else return false;" class="an_02">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" onclick="location.href='admin.php?controller=admin_config&action=appprogram_edit&appserverip=<?php echo $this->_tpl_vars['appserverip']; ?>
...
程序  <?php echo $this->_tpl_vars['page_list']; ?>
  <?php echo $this->_tpl_vars['language']['Page']; ?>
...
<input name="pagenum" type="text" class="wbk" size="2" onKeyPress="if(event.keyCode==13) window.location='admin.php?controller=admin_config&action=appprogram_list&page='+this.value;"><?php echo $this->_tpl_vars['language']['page']; ?>
