<?php /* Smarty version 2.6.18, created on 2014-07-01 13:32:39
         compiled from loginacct.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'loginacct.tpl', 125, false),)), $this); ?>
...
function searchit(){
	document.search.action = "admin.php?controller=admin_reports&action=loginacct";
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=loginacct">授权明细</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
