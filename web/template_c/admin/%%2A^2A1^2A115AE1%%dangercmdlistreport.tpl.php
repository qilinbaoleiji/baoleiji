<?php /* Smarty version 2.6.18, created on 2014-06-20 13:14:44
         compiled from dangercmdlistreport.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'dangercmdlistreport.tpl', 61, false),)), $this); ?>
...
/images/an11.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=dangercmdreport">违规统计</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
/images/an33.jpg" align="absmiddle"/></li>
	<li class="me_a"><img src="<?php echo $this->_tpl_vars['template_root']; ?>
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=dangercmdlistreport">违规操作</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						...
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=device_ip&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >运维用户</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=device_ip&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >别名</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=groupname&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >运维组</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=local_user&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >服务器IP</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=type&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >登录协议</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=protocol&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >系统用户</a></th>							
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=local_user&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >违规命令</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=dangercmdlistreport&orderby1=dangerlevel&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >违规级别</a></th>
...
?>
					<tr <?php if ($this->_sections['t']['index'] % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
						...
						<td width="10%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['type']; ?>
</td>
						<td width="10%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['luser']; ?>
</td>
						<td width="10%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['cmd']; ?>
</td>
						<td width="10%"><?php if ($this->_tpl_vars['reports'][$this->_sections['t']['index']]['dangerlevel'] == 2): ?>断开连接<?php elseif ($this->_tpl_vars['reports'][$this->_sections['t']['index']]['dangerlevel'] == 3): ?>命令监控<?php elseif ($this->_tpl_vars['reports'][$this->_sections['t']['index']]['dangerlevel'] == 4): ?>授权命令<?php else: ?>命令阻断<?php endif; ?></td>
						<td width="10%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['at']; ?>
</td>
					</tr>
					<?php endfor; endif; ?>
					<tr>
