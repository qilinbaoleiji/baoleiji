<?php /* Smarty version 2.6.18, created on 2014-06-20 08:48:27
         compiled from dangercmdreport.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'dangercmdreport.tpl', 61, false),)), $this); ?>
...
function searchit(){
	document.search.action = "admin.php?controller=admin_reports&action=dangercmdreport";
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=dangercmdreport">违规统计</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
/images/an3.jpg" align="absmiddle"/></li>
	<li class="me_b"><img src="<?php echo $this->_tpl_vars['template_root']; ?>
/images/an11.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=dangercmdlistreport">违规操作</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
