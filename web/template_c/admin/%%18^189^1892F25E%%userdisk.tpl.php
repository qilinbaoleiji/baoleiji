<?php /* Smarty version 2.6.18, created on 2014-05-07 09:57:30
         compiled from userdisk.tpl */ ?>
...
function doMkdir(form)
{
	...
	{
		alert("请正确输入目录名称, 名称中不能包含!@#$%^&*<?php echo '?>'; ?>
<[]{}~|\/ ");
		return false;
	}
...
<TD WIDTH="100%" ALIGN="center" VALIGN="top" class="main_content"><table width="96%" height="22" cellpadding="cellpadding" cellspacing="cellspacing" background="images/listbg.jpg">
  <form method="post" name="head" id="head">
    <tr style="color: #FFFFFF;" align="center">
      <td><span class="STYLE2">当前路径: <U><?php echo $this->_tpl_vars['OUT']['pathname']; ?>
</U> </span></td>
      <td><span class="STYLE2">总文件数:  <U><?php echo $this->_tpl_vars['OUT']['totalfile']; ?>
</U> </span></td>
      <td><span class="STYLE2">空间容量: <U><?php echo $this->_tpl_vars['OUT']['LANG_FILE_DISK_QUOTA']; ?>
MB</U> 已占用空间:</span> <span class="STYLE2"><U><?php echo $this->_tpl_vars['OUT']['totalsize']; ?>
</U> 剩余空间:</span> <span class="STYLE2"><U><?php echo $this->_tpl_vars['OUT']['remain']; ?>
</U></span></td>
...
<FORM NAME="List" METHOD="post" ACTION="">
      ...
      <input name="path" type="hidden" id="path" value="<?php echo $this->_tpl_vars['OUT']['path']; ?>
">      </th>
                  </TR>
</form>
			<?php echo $this->_tpl_vars['ListOut']; ?>
  ...
  <FORM NAME="form1" METHOD="post" ACTION="">
    <TR>
      <TD><input type="button" name="Submit" value="返回根目录" class="myinput" onClick="doGotoRoot(this.form, '');return false">
        <input type="button" name="Submit2" value="返回上级" class="myinput" onClick="doGotoRoot(this.form, '<?php echo $this->_tpl_vars['OUT']['pre_path']; ?>
');return false"></TD>
      <TD><strong> 
