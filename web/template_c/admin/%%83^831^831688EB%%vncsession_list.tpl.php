<?php /* Smarty version 2.6.18, created on 2014-05-09 22:49:57
         compiled from vncsession_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'vncsession_list.tpl', 172, false),)), $this); ?>
...
function searchit(){
	document.search.action = "admin.php?controller=admin_vnc&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
";
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_vnc&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
...
/images/an33.jpg" align="absmiddle"/></li> 
   ...
   <tr>
          <td >
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="main_content"><form action="admin.php?controller=admin_vnc&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d %H:%M:%S");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						<th class="list_bg"   width="6%"><a href="admin.php?controller=admin_vnc&orderby1=cli_addr&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
"><?php echo $this->_tpl_vars['language']['SourceAddress']; ?>
</a></th>
						<th class="list_bg"   width="6%"><a href="admin.php?controller=admin_vnc&orderby1=addr&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
"><?php echo $this->_tpl_vars['language']['DeviceAddress']; ?>
</a></th>
						
						<th class="list_bg"   width="4%"><a href="admin.php?controller=admin_vnc&orderby1=luser&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
">运维</a></th>
						<th class="list_bg"   width="4%"><a href="admin.php?controller=admin_vnc&orderby1=realname&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
">真实姓名</a></th>
						<th class="list_bg"   width="4%"><a href="admin.php?controller=admin_vnc&orderby1=user&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
"><?php echo $this->_tpl_vars['language']['LocalUser']; ?>
</a></th>
						<th class="list_bg"   width="9%"><a href="admin.php?controller=admin_vnc&orderby1=start&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
"><?php echo $this->_tpl_vars['language']['StartTime']; ?>
</a></th>
						<th class="list_bg"   width="9%"><a href="admin.php?controller=admin_vnc&orderby1=end&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
"><?php echo $this->_tpl_vars['language']['EndTime']; ?>
</a></th>
						<th class="list_bg"   width="6%"><a href="admin.php?controller=admin_vnc&orderby1=filesize&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
"><?php echo $this->_tpl_vars['language']['flow']; ?>
(K)</a></th>
...
?>
					<tr <?php if ($this->_tpl_vars['allsession'][$this->_sections['t']['index']]['dangerous'] > 1): ?>bgcolor="red"<?php elseif ($this->_tpl_vars['allsession'][$this->_sections['t']['index']]['dangerous'] > 0): ?>bgcolor="yellow" <?php elseif ($this->_sections['t']['index'] % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
										<td><a href="admin.php?controller=admin_vnc&srcaddr=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['cli_addr']; ?>
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['cli_addr']; ?>
</a></td>
					
					<td><a href="admin.php?controller=admin_vnc&addr=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['addr']; ?>
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['addr']; ?>
</a></td>
					
					<td><a href="admin.php?controller=admin_vnc&luser=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['luser']; ?>
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['luser']; ?>
</a></td>
					<td><a href="admin.php?controller=admin_vnc&realname=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['realname']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['realname']; ?>
</a></td>
					<td><a href="admin.php?controller=admin_vnc&user=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['user']; ?>
...
')" href="#" target="hide"><?php echo $this->_tpl_vars['language']['Replay']; ?>
</a>&nbsp;<?php if ($this->_tpl_vars['windows_version'] != '5.2'): ?>| <img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
&activex=1&sid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
&action=inputview" target="_blank"><?php echo $this->_tpl_vars['language']['Input']; ?>
</a>
					<?php if ($this->_tpl_vars['allsession'][$this->_sections['t']['index']]['rdp_runnig'] == 1): ?><a href="admin.php?controller=admin_vncrun&action=cutoff&sid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
" target="hide">断开</a><?php endif; ?>
						&nbsp;&nbsp;<img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
&action=logindesc&type=vnc&sessionid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
...
/images/disconnect.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_vnc&action=del_session&sid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
"><?php echo $this->_tpl_vars['language']['Delete']; ?>
</a><?php endif; ?><?php else: ?><img src="<?php echo $this->_tpl_vars['template_root']; ?>
