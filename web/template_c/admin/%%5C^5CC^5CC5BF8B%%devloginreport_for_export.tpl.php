<?php /* Smarty version 2.6.18, created on 2014-06-23 01:14:53
         compiled from devloginreport_for_export.tpl */ ?>
...
——审计报表</td>         
  ...
  <tr>
	<td class="main_content">
		...
		<tr>
					<td colspan="9">日期:<?php echo $this->_tpl_vars['f_rangeStart']; ?>
...
?>
					<tr <?php if ($this->_sections['t']['index'] % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
						<td width="5%"><?php echo $this->_sections['t']['index']+1; ?>
</td>
						<td width="8%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['luser']; ?>
</td>
