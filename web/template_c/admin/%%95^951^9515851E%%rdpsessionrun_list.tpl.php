<?php /* Smarty version 2.6.18, created on 2014-04-23 14:16:35
         compiled from rdpsessionrun_list.tpl */ ?>
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_rdprun">RDP实时监控</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['luser']; ?>
					...
					<td><a href="admin.php?controller=admin_rdp&realname=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['realname']; ?>
...
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['user']; ?>
					...
					<td><a href="admin.php?controller=admin_session&addr=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['cli_addr']; ?>
...
/images/disconnect.png" width="16" height="16" align="absmiddle">
					<a href="admin.php?controller=admin_rdprun&action=cutoff&sid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
" >断开</a>
