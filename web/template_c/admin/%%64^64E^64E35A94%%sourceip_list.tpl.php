<?php /* Smarty version 2.6.18, created on 2014-05-19 21:33:06
         compiled from sourceip_list.tpl */ ?>
...
/images/an33.jpg" align="absmiddle"/></li>
	<?php endif; ?>
</ul><span class="back_img"><A href="admin.php?controller=admin_pro&action=sourceip&back=1"><IMG src="<?php echo $this->_tpl_vars['template_root']; ?>
/images/back1.png" 
  ...
  <tr>
	<td class=""><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="BBtable">
                <TBODY>
                  ...
                  <TR>
                    <th class="list_bg" ><a href="admin.php?controller=admin_pro&action=sourceip_list&orderby1=sourceip&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >Source IP</a></TD>
...
?>
 ...
 <td> <?php echo $this->_tpl_vars['s'][$this->_sections['t']['index']]['sourceip']; ?>
</td>	
				<td>
...
？')) {return false;} else { location.href='admin.php?controller=admin_pro&action=sourceiplist_delete&sid=<?php echo $this->_tpl_vars['s'][$this->_sections['t']['index']]['sid']; ?>
';}"><?php echo $this->_tpl_vars['language']['Delete']; ?>
</a>
				</td> 
			</tr>
			<?php endfor; endif; ?>
			<tr><td  colspan="5" align="right"><?php echo $this->_tpl_vars['language']['Example']; ?>
: 127.0.0.0/8 <?php echo $this->_tpl_vars['language']['or']; ?>
 10.0.0.0/255.0.0.0</td></tr>
	          <tr>
	           <td  colspan="5" align="right">
		           <form action="admin.php?controller=admin_pro&action=sourceiplist_save&groupname=<?php echo $this->_tpl_vars['groupname']; ?>
" method="post">
					<input type="text" class="wbk" name="ip" />
					<input type="submit" name="submit" value="<?php echo $this->_tpl_vars['language']['Add']; ?>
" />
					</form>
		   		</td>
		   		</tr>
