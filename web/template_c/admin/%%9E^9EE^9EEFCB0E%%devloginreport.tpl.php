<?php /* Smarty version 2.6.18, created on 2014-07-01 13:33:25
         compiled from devloginreport.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'devloginreport.tpl', 65, false),)), $this); ?>
...
function searchit(){
	document.search.action = "admin.php?controller=admin_reports&action=devloginreport";
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=devloginreport">系统登录报表</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
" >主机名</a></th>						
						<th class="list_bg"   width="5%"><a href="admin.php?controller=admin_reports&action=commandreport&orderby1=fort_user&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >协议</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_reports&action=commandreport&orderby1=protocol&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >系统用户</a></th>	
						<th class="list_bg"   width="7%"><a href="admin.php?controller=admin_reports&action=commandreport&orderby1=fort_user&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >登录次数</a></th>
...
?>
					<tr <?php if ($this->_sections['t']['index'] % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
						...
						<td width="5%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['type']; ?>
</td>
						<td width="10%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['user']; ?>
</td>
						<td width="7%"><?php echo $this->_tpl_vars['reports'][$this->_sections['t']['index']]['ct']; ?>
</td>
