<?php /* Smarty version 2.6.18, created on 2014-07-01 11:43:30
         compiled from ftpsession_list.tpl */ ?>
...
function searchit(){
	document.search.action = "admin.php?controller=admin_ftp&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
";
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_ftp&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
...
/images/an33.jpg" align="absmiddle"/></li> 
   ...
   <tr>
       ...
       <td >
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="main_content"><form action="admin.php?controller=admin_ftp&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
...
<input  type="text" class="wbk" name="f_rangeEnd" size="13" id="f_rangeEnd" value="" />
 <input type="button" onClick="changetype('timetype3')" id="f_rangeEnd_trigger" name="f_rangeEnd_trigger" value="选择时间" class="wbk">
	  &nbsp;&nbsp;<input type="submit" height="35" align="middle" onClick="return searchit();" border="0" value=" 确定 " class="bnnew2"/>&nbsp;&nbsp;<input id="filtercheck" type="checkbox" onclick="filter1();" name="filter" value="1" <?php if ($this->_tpl_vars['filter']): ?>checked<?php endif; ?> >过滤
 </td>
  </tr></form>
</table>
...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d %H:%M:%S");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						...
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=cliaddr&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
">来源地址</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=svraddr&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
"><?php echo $this->_tpl_vars['language']['DestinationAddress']; ?>
</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=radius_user&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
">运维</a></th>	
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=realname&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
">真实姓名</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=ftp_user&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
"><?php echo $this->_tpl_vars['language']['LocalUser']; ?>
</a></th>					
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=start&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
"><?php echo $this->_tpl_vars['language']['StartTime']; ?>
</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_ftp&orderby1=end&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
"><?php echo $this->_tpl_vars['language']['EndTime']; ?>
</a></th>
						<th class="list_bg"   width="18%"><a href="admin.php?controller=admin_ftp&orderby1=addr&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
"><?php echo $this->_tpl_vars['language']['Detail']; ?>
</th>
					</tr>
...
?>
					...
					<td><a href="admin.php?controller=admin_ftp&cliaddr=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['cliaddr']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['cliaddr']; ?>
</a></td>
						
						<td><a href="admin.php?controller=admin_ftp&svraddr=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['svraddr']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['svraddr']; ?>
</a></td>
						
						<td><a href="admin.php?controller=admin_ftp&radius_user=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['radius_user']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['radius_user']; ?>
</a></td>
						<td><a href="admin.php?controller=admin_ftp&radius_user=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['realname']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['realname']; ?>
</a></td>
						<td><a href="admin.php?controller=admin_ftp&ftp_user=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['ftp_user']; ?>
&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['ftp_user']; ?>
</a></td>
...
/images/ico2.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_ftp&action=view&sid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
...
&action=logindesc&type=ftp&sessionid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
...
&action=logincommit&type=ftp" target="hide" >说明</a><?php endif; ?>

						<?php if (0): ?> <?php if (! $this->_tpl_vars['backupdb_id']): ?>| <img src="<?php echo $this->_tpl_vars['template_root']; ?>
/images/cross.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_ftp&action=del_session&sid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
