<?php /* Smarty version 2.6.18, created on 2014-06-26 14:32:52
         compiled from rdpsession_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'rdpsession_list.tpl', 175, false),)), $this); ?>
...
function searchit(){
	document.search.action = "admin.php?controller=admin_rdp&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
";
...
/images/an33.jpg" align="absmiddle"/></li> 
  ...
  <tr>
         <td >
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="main_content"><form action="admin.php?controller=admin_rdp&backupdb_id=<?php echo $this->_tpl_vars['backupdb_id']; ?>
...
&action=rdpmouse" >鼠标</a>
						&nbsp;| <img src="<?php echo $this->_tpl_vars['template_root']; ?>
/images/i_4.gif" width="16" height="16" align="absmiddle"><a href="<?php echo $this->_tpl_vars['curr_url']; ?>
&activex=1&sid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
&action=clipboard" target="_blank">剪贴板</a>
						<?php else: ?><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
&action=logindesc&type=rdp&sessionid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
