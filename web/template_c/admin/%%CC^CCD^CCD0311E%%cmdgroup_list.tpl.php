<?php /* Smarty version 2.6.18, created on 2014-04-26 16:20:40
         compiled from cmdgroup_list.tpl */ ?>
	...
	<td class="">
		...
		<table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
			...
			<tr>
				...
				<th class="list_bg"  width="15%"><a href="admin.php?controller=admin_forbidden&action=cmdgroup_list&orderby1=groupname&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >组名</a></th>
...
/images/edit_ico.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_forbidden&action=cmdgroup_cmd&gid=<?php echo $this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['groupname']; ?>
">命令编辑</a>
				| <img src="<?php echo $this->_tpl_vars['template_root']; ?>
/images/scico.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_forbidden&action=del_cmdgroup&gid=<?php echo $this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['groupname']; ?>
">删除</a>
				</td>
			</tr>
			<?php endfor; endif; ?>
