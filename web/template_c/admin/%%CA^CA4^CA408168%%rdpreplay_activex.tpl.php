<?php /* Smarty version 2.6.18, created on 2014-05-08 22:55:53
         compiled from rdpreplay_activex.tpl */ ?>
<html>
<head>
<title><?php echo $this->_tpl_vars['ip']; ?>
</title>
...
sub BtnConnect
   ...
   MsRdpClient.server = "<?php echo $this->_tpl_vars['proxy_addr']; ?>
"
   If Err then 
   ...
   Document.all.srvNameField.innerHtml = "<?php echo $this->_tpl_vars['proxy_addr']; ?>
"
   
   'Username/Domain
   if Document.all.CheckBoxAutoLogon.checked then
      MsRdpClient.UserName = "<?php echo $this->_tpl_vars['username']; ?>
"
	  MsRdpClient.AdvancedSettings.RDPPort = "<?php echo $this->_tpl_vars['port']; ?>
"
   ...
   MsRdpClient.DesktopWidth = "<?php echo $this->_tpl_vars['resWidth']; ?>
"
   MsRdpClient.DesktopHeight = "<?php echo $this->_tpl_vars['resHeight']; ?>
"
...
<!-- Column 4 -->		  
	...
	<br>&nbsp;&nbsp;<input type="text" class="wbk" name="Server" size="41" id="editServer" value="<?php echo $this->_tpl_vars['localhost']; ?>
">
...
<td valign="bottom">&nbsp;&nbsp;<select  class="wbk"  size="1" name="comboResolution" id=comboRes class="topspace">
             <option value="3" <?php if ($this->_tpl_vars['screen'] == 3): ?>selected<?php endif; ?>><ID id=option1>全屏显示</ID></option>
              <option value="1" <?php if ($this->_tpl_vars['screen'] == 1): ?>selected<?php endif; ?>><ID id=option3>800 x 600</ID></option>
              <option value="2" <?php if ($this->_tpl_vars['screen'] == 2): ?>selected<?php endif; ?>><ID id=option4>1024 x 768</ID></option>
            </select> </label>
</td>
</tr>
<!-- Row 3 -->
...
<span ID="tableLogonInfo" style="display: inline">
			...
			<ID id=usernamelabel>用户名(<u>U</u>)&nbsp;:</ID>
                <label id=UserNameKey accessKey="U" for="editUserName"><input type="text" class="wbk" name="UserName" id=editUserName size="25" value="<?php echo $this->_tpl_vars['username']; ?>
"></label><br>
			<ID id=usernamelabel>密码(<u>P</u>)&nbsp;:</ID>
                <label id=UserNameKey accessKey="P" for="editPassWord"><input type="text" class="wbk" name="PassWord" id=editPassWord size="25" value="<?php echo $this->_tpl_vars['password']; ?>
"></label><br>
...
"/>
	  ...
	  <param name = "username" value = "<?php echo $this->_tpl_vars['session']['sid']; ?>
" />
	  <param name = "window_size" value = "<?php echo $this->_tpl_vars['resWidth']; ?>
--<?php echo $this->_tpl_vars['resHeight']; ?>
" />
