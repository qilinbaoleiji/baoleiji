<?php /* Smarty version 2.6.18, created on 2014-04-23 13:00:35
         compiled from reportgraph.tpl */ ?>
...
<script language="JavaScript">
	...
	$(document).ready(function() {
		var arr = <?php echo $this->_tpl_vars['top10user']; ?>
;
		getBar('top10user','username','堡垒机用户排行TOP10 ',arr);
		
		var arr = <?php echo $this->_tpl_vars['top10protocol']; ?>
;
		getPie('top10protocol','protocol','协议使用',arr);
		
		var arr = <?php echo $this->_tpl_vars['top10srcip']; ?>
;
		getBar('top10srcip','sourceip','登录来源IP',arr);
		
		var arr = <?php echo $this->_tpl_vars['top10dstip']; ?>
;
		getBar('top10dstip','serverip','登录目标IP',arr);
		
		var arr = <?php echo $this->_tpl_vars['last10user']; ?>
;
...
/images/an1.jpg" align="absmiddle"/><a href="admin.php?controller=admin_reports&action=reportgraph" id="statisticreport" target="">图形输出</a><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
<tr><td align="right"><a href="<?php echo $this->_tpl_vars['curr_url']; ?>
&derive=2" >导出到HTML</a> &nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
</table>
 <script type="text/javascript">
