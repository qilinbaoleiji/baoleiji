<?php /* Smarty version 2.6.18, created on 2014-07-01 13:53:22
         compiled from autotemplate.tpl */ ?>
...
<?php endif; ?>
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
		<form name="f1" method=post OnSubmit='return check()' action="admin.php?controller=admin_assets&action=autobackup_delete&type=<?php echo $_GET['type']; ?>
">
			<tr>
				<th class="list_bg"  width="3%">选</th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=admin_autorun&orderby1=name&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >名称</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=admin_autorun&orderby1=templatepath&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >模板位置</a></th>
				<th class="list_bg"  width="10%"><a href="admin.php?controller=admin_autorun&action=admin_autorun&orderby1=desc&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >模板描述</a></th>
...
"></td>
				...
				<td><?php echo $this->_tpl_vars['alldev'][$this->_sections['t']['index']]['scriptpath']; ?>
</td>
				<td><?php echo $this->_tpl_vars['alldev'][$this->_sections['t']['index']]['desc']; ?>
</ td>
				<td style="TEXT-ALIGN: left;"><img src='./template/admin/images/edit_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href='admin.php?controller=admin_autorun&action=viewtemplate&id=<?php echo $this->_tpl_vars['alldev'][$this->_sections['t']['index']]['id']; ?>
' target="_blank">查看</a>| <img src='./template/admin/images/delete_ico.gif' width=16 height='16' hspace='5' border='0' align='absmiddle'><a href='admin.php?controller=admin_autorun&action=autotemplate_del&id=<?php echo $this->_tpl_vars['alldev'][$this->_sections['t']['index']]['id']; ?>
'>删除</a></td>
			</tr>
			<?php endfor; endif; ?>
...
');if(chk_form()) document.f1.action='admin.php?controller=admin_autorun&action=autotemplate_del'; else return false;" class="an_02">
				&nbsp;&nbsp;
