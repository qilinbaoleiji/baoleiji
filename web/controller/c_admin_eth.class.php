...
class c_admin_eth extends c_base {
	...
	function serverstatus(){
		...
		$serverArr = array(
						array('name'=>'vpn','sname'=>'vpn', 'desc'=>'系统SSL VPN服务'),
						...
						array('name'=>'radius','sname'=>'radiusd', 'desc'=>'系统radius 服务'),
		...
		if(empty($_CONFIG['db-audit'])){
			$serverArr = array_reverse($serverArr);
	...
	function downloadlog(){
		...
		exec("sudo cp /var/log/mysqld.log ".$root);
