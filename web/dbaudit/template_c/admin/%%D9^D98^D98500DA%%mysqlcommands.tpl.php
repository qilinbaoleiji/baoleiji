<?php /* Smarty version 2.6.18, created on 2014-05-08 16:33:58
         compiled from mysqlcommands.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlspecialchars', 'mysqlcommands.tpl', 38, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?><span class="back_img"><a href="admin.php?controller=admin_mysql&back=1" ><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
<input name="pagenum" type="text" size="2" onKeyPress="if(event.keyCode==13) window.location='admin.php?controller=admin_mysqlon&action=&page='+this.value;"><?php echo $this->_tpl_vars['language']['page']; ?>
