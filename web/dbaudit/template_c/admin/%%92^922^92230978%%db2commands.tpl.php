<?php /* Smarty version 2.6.18, created on 2013-07-10 10:53:37
         compiled from db2commands.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlspecialchars', 'db2commands.tpl', 42, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?></td></tr>
  <tr>
	<td align="right"><a href="admin.php?controller=admin_db2&back=1" ><img src="<?php echo $this->_tpl_vars['template_root']; ?>
...
<input name="pagenum" type="text" size="2" onKeyPress="if(event.keyCode==13) window.location='admin.php?controller=admin_db2on&action=&page='+this.value;"><?php echo $this->_tpl_vars['language']['page']; ?>
