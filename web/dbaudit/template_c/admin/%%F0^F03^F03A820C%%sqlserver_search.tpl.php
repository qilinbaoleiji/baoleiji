<?php /* Smarty version 2.6.18, created on 2013-09-12 23:49:07
         compiled from sqlserver_search.tpl */ ?>
...
<?php echo $this->_tpl_vars['language']['Content']; ?>
						...
						<table><tr >
							...
							<input type="radio" name="controller" value="admin_sqlserver" checked  onClick="location.href='admin.php?controller=admin_sqlserver&action=search'" >SqlServer<?php echo $this->_tpl_vars['language']['Session']; ?>
...
<?php echo $this->_tpl_vars['language']['EndTime']; ?>
					...
					<tr>
						<td class="td_line" width="30%"><?php echo $this->_tpl_vars['language']['Username']; ?>
：</td>
