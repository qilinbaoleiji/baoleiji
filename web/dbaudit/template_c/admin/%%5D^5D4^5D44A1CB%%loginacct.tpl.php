<?php /* Smarty version 2.6.18, created on 2013-12-31 10:35:59
...
function searchit(){
	document.search.action = "admin.php?controller=admin_loginaccount&action=<?php echo $this->_tpl_vars['action']; ?>
";
...
<form action="admin.php?controller=admin_loginaccount&action=<?php echo $this->_tpl_vars['action']; ?>
