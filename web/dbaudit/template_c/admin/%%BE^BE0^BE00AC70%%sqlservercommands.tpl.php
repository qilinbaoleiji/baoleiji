<?php /* Smarty version 2.6.18, created on 2013-06-27 17:00:19
         compiled from sqlservercommands.tpl */ ?>
...
<input name="pagenum" type="text" size="2" onKeyPress="if(event.keyCode==13) window.location='admin.php?controller=admin_sqlserveron&action=&page='+this.value;"><?php echo $this->_tpl_vars['language']['page']; ?>
