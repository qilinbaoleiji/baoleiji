<?php /* Smarty version 2.6.18, created on 2013-12-31 00:30:33
         compiled from mysqlsession_list.tpl */ ?>
...
function selecttable(table){
	window.location='admin.php?controller=admin_mysql&tablename='+table;
...
cal.manageFields("f_rangeEnd_trigger", "f_rangeEnd", "%Y-%m-%d %H:%M:%S");
  ...
  <tr><td><table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
					<tr>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_mysql&orderby1=d_addr&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
">目的地址</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_mysql&orderby1=user&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
">登录用户名</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_mysql&orderby1=start&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
">开始时间</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_mysql&orderby1=end&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
">结束时间</a></th>
						<th class="list_bg"   width="10%"><a href="admin.php?controller=admin_mysql&orderby1=commands&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
">命令条数</a></th>
...
?>
					<tr <?php if ($this->_tpl_vars['allsession'][$this->_sections['t']['index']]['dangerous'] > 5): ?>bgcolor="red"<?php elseif ($this->_tpl_vars['allsession'][$this->_sections['t']['index']]['dangerous'] > 0): ?>bgcolor="yellow" <?php elseif ($this->_sections['t']['index'] % 2 == 0): ?>bgcolor="f7f7f7"<?php endif; ?>>
						<td><a href="admin.php?controller=admin_mysql&d_addr=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['d_addr']; ?>
"><?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['d_addr']; ?>
</a></td>
						<td><a href="admin.php?controller=admin_mysql&user=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['user']; ?>
...
/images/ico2.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_mysql&action=view&sid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
...
/images/doc_table.gif" width="16" height="16" align="absmiddle">
						<a style="cursor:hand" onclick="javascript:window.open('admin.php?controller=admin_mysql&action=detail&sid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
...
/images/scico.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_mysql&action=del_session&sid=<?php echo $this->_tpl_vars['allsession'][$this->_sections['t']['index']]['sid']; ?>
">删除</a><?php endif; ?></td>
					</tr>
					<?php endfor; endif; ?>
					<tr>
