<?php /* Smarty version 2.6.18, created on 2013-12-31 00:37:28
         compiled from sqloptions_list.tpl */ ?>
	...
	<td class="">
		...
		<table bordercolor="white" cellspacing="0" cellpadding="5" border="0" width="100%" class="BBtable">
			...
			<tr>
				...
				<th class="list_bg"  width="15%"><a href="admin.php?controller=admin_sqloptions&action=sqloptions_list&orderby1=optionsname&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >组名</a></th>
				<th class="list_bg"  width="15%"><a href="admin.php?controller=admin_sqloptions&action=sqloptions_list&orderby1=desc&orderby2=<?php echo $this->_tpl_vars['orderby2']; ?>
" >描述</a></th>
...
"></td>
				<td><a href="admin.php?controller=admin_sqloptions&action=sqloptions_cmd&optionsname=<?php echo $this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['optionsname']; ?>
"><?php echo $this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['optionsname']; ?>
</a></td>
				<td><?php echo $this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['desc']; ?>
</td>
				<td style="TEXT-ALIGN: left;"><img src="<?php echo $this->_tpl_vars['template_root']; ?>
/images/list_ico5.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_sqloptions&action=sqloptions_cmd&optionsname=<?php echo $this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['optionsname']; ?>
">命令</a>
				| <img src="<?php echo $this->_tpl_vars['template_root']; ?>
/images/edit_ico.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_sqloptions&action=sqloptions_edit&id=<?php echo $this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['id']; ?>
">编辑</a>
				| <img src="<?php echo $this->_tpl_vars['template_root']; ?>
/images/scico.gif" width="16" height="16" align="absmiddle"><a href="admin.php?controller=admin_sqloptions&action=del_sqloptions&id=<?php echo $this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['id']; ?>
">删除</a>
				</td>
			</tr>
			<?php endfor; endif; ?>
