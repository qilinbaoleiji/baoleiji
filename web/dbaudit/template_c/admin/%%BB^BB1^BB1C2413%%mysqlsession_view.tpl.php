<?php /* Smarty version 2.6.18, created on 2014-05-07 12:26:03
         compiled from mysqlsession_view.tpl */ ?>
...
?>
			...
			<td><?php if ($this->_tpl_vars['allcommand'][$this->_sections['t']['index']]['return_code'] == 'NULL'): ?>成功<?php else: ?>失败<?php endif; ?></td>
			</tr>
			<?php endfor; endif; ?>
			<tr>
