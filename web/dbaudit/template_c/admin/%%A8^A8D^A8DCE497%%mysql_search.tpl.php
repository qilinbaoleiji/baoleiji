<?php /* Smarty version 2.6.18, created on 2013-09-12 23:49:15
         compiled from mysql_search.tpl */ ?>
...
<?php echo $this->_tpl_vars['language']['Content']; ?>
						...
						<td>
							...
							<td width="100">
							<input type="radio" name="controller" value="admin_mysql" checked>Mysql<?php echo $this->_tpl_vars['language']['Session']; ?>
