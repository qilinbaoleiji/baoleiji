...
<form name="f1" method=post OnSubmit='return check()' action="admin.php?controller=admin_config&action=syslog_mail_alarm">
	...
	<tr bgcolor="f7f7f7"><td align="right">{{$language.StartupsyslogAlert}}:</td>
		<td align=left>&nbsp;
	...
	<tr><td align="right">syslog{{$language.Server}}:</td>
		<td align=left>&nbsp;
		<input type="text" class="wbk" name="syslogserver" value="{{$alarm.syslogserver}}" />
		</td>
		
	</tr>
	<tr bgcolor="f7f7f7"><td align="right">syslog{{$language.port}}:</td>
		<td align=left>&nbsp;
		<input type="text" class="wbk" name="syslogport" value="{{$alarm.syslogport}}" />
		</td>
		
	</tr>
	<tr><td align="right">syslog{{$language.device}}:</td>
		<td align=left>&nbsp;
