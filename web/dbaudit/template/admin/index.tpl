        ...
        <td width="200" align="right" valign="top"><table width="200" height="31" border="0" cellpadding="0" cellspacing="0" class="lj_hei">
          <tr>
            ...
            <ul id="navigation"> 
	            ...
	            <img src="{{$template_root}}/images/yw_07.jpg" width="16" height="16" align="absmiddle" />主页</a>
	            </li>
	            <li><a href="admin.php?controller=admin_index&amp;action=logout"><img src="{{$template_root}}/images/yw_09.jpg" width="15" height="16" align="absmiddle" />退出</a>
	            </li>
...
{{/if}}
{{if $amdin_level ==1 or $amdin_level ==2 }}
show_box('audit');
