...
<form method="get" name="session_search" action="admin.php">
 ...
 <td> {{$language.Search}}{{$language.Session}}{{$language.Content}}</td>
						...
						<table><tr >
							...
							<input type="radio" name="controller" value="admin_sqlserver" checked  onClick="location.href='admin.php?controller=admin_sqlserver&action=search'" >SqlServer{{$language.Session}}
							</td>
							<td width="100">
